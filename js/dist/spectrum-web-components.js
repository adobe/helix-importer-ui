...
`;var ft=Object.defineProperty,yt=Object.getOwnPropertyDescriptor,xt=(t,e,r,o)=>{for(var s,a=o>1?void 0:o?yt(e,r):e,c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o?s(e,r,a):s(a))||a);return o&&a&&ft(e,r,a),a};class kt extends(Q(gt(U))){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[vt]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[t.dy`
