...
`;var yo=Object.defineProperty,ko=Object.getOwnPropertyDescriptor,wo=(t,e,o,r)=>{for(var a,s=r>1?void 0:r?ko(e,o):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(r?a(e,o,s):a(s))||s);return r&&s&&yo(e,o,s),s};class zo extends u.o{constructor(){super(...arguments),this.disabled=!1,this.focused=!1,this.open=!1,this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[xo]}handlePointerdown(t){"touch"===t.pointerType&&(this.open=!0),this.setPointerCapture(t.pointerId)}handlePointerup(t){this.open=!1,this.releasePointerCapture(t.pointerId)}render(){return t.dy`
...
`;var Eo=i(731);customElements.define("sp-icon-chevron100",class extends v{render(){return xt(t.dy),ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
...
`;var gr=Object.defineProperty,fr=Object.getOwnPropertyDescriptor,xr=(t,e,o,r)=>{for(var a,s=r>1?void 0:r?fr(e,o):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(r?a(e,o,s):a(s))||s);return r&&s&&gr(e,o,s),s};class yr extends(w(u.o)){constructor(){super(...arguments),this.icon=!1,this.variant="neutral"}static get styles(){return[vr]}render(){return t.dy`
...
`;var wr=Object.defineProperty,zr=Object.getOwnPropertyDescriptor,Cr=(t,e,o,r)=>{for(var a,s=r>1?void 0:r?zr(e,o):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(r?a(e,o,s):a(s))||s);return r&&s&&wr(e,o,s),s};class Ir extends u.o{constructor(){super(...arguments),this.allowMultiple=!1,this.focusGroupController=new U(this,{direction:"vertical",elements:()=>this.items,isFocusableElement:t=>!t.disabled})}static get styles(){return[kr]}get items(){return[...this.defaultNodes||[]].filter((t=>void 0!==t.tagName))}focus(){this.focusGroupController.focus()}async onToggle(t){const e=t.target;if(await 0,this.allowMultiple||t.defaultPrevented)return;const o=[...this.items];o&&!o.length||o.forEach((t=>{t!==e&&(t.open=!1)}))}handleSlotchange(){this.focusGroupController.clearElementCache()}render(){return t.dy`
            <slot
                @slotchange=${this.handleSlotchange}
