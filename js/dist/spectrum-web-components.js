...
`;var ao=Object.defineProperty,io=Object.getOwnPropertyDescriptor,no=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?io(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&ao(e,o,c),c};class lo extends(ht(L)){static get styles(){return[co]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}no([(0,d.IO)("#anchor")],lo.prototype,"anchorElement",2),no([(0,d.Cb)({type:String,reflect:!0})],lo.prototype,"variant",2),no([(0,d.Cb)({type:String,reflect:!0})],lo.prototype,"static",2),customElements.define("sp-link",lo);const uo=t.iv`
