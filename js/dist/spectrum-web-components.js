...
`;var jo=Object.defineProperty,qo=Object.getOwnPropertyDescriptor,_o=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?qo(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&jo(e,o,c),c};function To(t,e){return!!e&&(t===e||t.contains(e))}class Ho extends(z(u.o,{noDefaultSize:!0})){constructor(){super(),this.label="",this.ignore=!1,this.value="",this.valueSeparator=",",this._selected=[],this.selectedItems=[],this.childItemSet=new Set,this.focusedItemIndex=0,this.focusInItemIndex=0,this.selectedItemsMap=new Map,this.descendentOverlays=new Map,this.handleSubmenuClosed=t=>{t.stopPropagation(),t.composedPath()[0].dispatchEvent(new Event("sp-menu-submenu-closed",{bubbles:!0,composed:!0}))},this.handleSubmenuOpened=t=>{t.stopPropagation(),t.composedPath()[0].dispatchEvent(new Event("sp-menu-submenu-opened",{bubbles:!0,composed:!0}));const e=this.childItems[this.focusedItemIndex];e&&(e.focused=!1);const o=t.composedPath().find((t=>this.childItemSet.has(t)));if(!o)return;const r=this.childItems.indexOf(o);this.focusedItemIndex=r,this.focusInItemIndex=r},this._hasUpdatedSelectedItemIndex=!1,this._willUpdateItems=!1,this.cacheUpdated=Promise.resolve(),this.resolveCacheUpdated=()=>{},this.addEventListener("sp-menu-item-added-or-updated",this.onSelectableItemAddedOrUpdated),this.addEventListener("sp-menu-item-added-or-updated",this.onFocusableItemAddedOrUpdated,{capture:!0}),this.addEventListener("click",this.handleClick),this.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout),this.addEventListener("sp-opened",this.handleSubmenuOpened),this.addEventListener("sp-closed",this.handleSubmenuClosed)}static get styles(){return[Ao]}get isSubmenu(){return"submenu"===this.slot}get selected(){return this._selected}set selected(t){if(t===this.selected)return;const e=this.selected;this._selected=t,this.selectedItems=[],this.selectedItemsMap.clear(),this.childItems.forEach((t=>{t.selected=this.selected.includes(t.value),t.selected&&(this.selectedItems.push(t),this.selectedItemsMap.set(t,!0))})),this.requestUpdate("selected",e)}get childItems(){return this.cachedChildItems||(this.cachedChildItems=this.updateCachedMenuItems()),this.cachedChildItems}updateCachedMenuItems(){if(this.cachedChildItems=[],!this.menuSlot)return[];const t=this.menuSlot.assignedElements({flatten:!0});for(const[e,o]of t.entries()){if(this.childItemSet.has(o)){this.cachedChildItems.push(o);continue}const r="slot"===o.localName?o.assignedElements({flatten:!0}):[...o.querySelectorAll(":scope > *")];t.splice(e,1,o,...r)}return this.cachedChildItems}get childRole(){if("listbox"===this.resolvedRole)return"option";switch(this.resolvedSelects){case"single":return"menuitemradio";case"multiple":return"menuitemcheckbox";default:return"menuitem"}}get ownRole(){return"menu"}onFocusableItemAddedOrUpdated(t){t.menuCascade.set(this,{hadFocusRoot:!!t.item.menuData.focusRoot,ancestorWithSelects:t.currentAncestorWithSelects}),this.selects&&(t.currentAncestorWithSelects=this),t.item.menuData.focusRoot=t.item.menuData.focusRoot||this}onSelectableItemAddedOrUpdated(t){var e,o;const r=t.menuCascade.get(this);if(!r)return;if(t.item.menuData.parentMenu=t.item.menuData.parentMenu||this,r.hadFocusRoot&&!this.ignore&&(this.tabIndex=-1),this.addChildItem(t.item),"inherit"===this.selects){this.resolvedSelects="inherit";const r=null==(e=t.currentAncestorWithSelects)?void 0:e.ignore;this.resolvedRole=r?"none":(null==(o=t.currentAncestorWithSelects)?void 0:o.getAttribute("role"))||this.getAttribute("role")||void 0}else this.selects?(this.resolvedRole=this.ignore?"none":this.getAttribute("role")||void 0,this.resolvedSelects=this.selects):(this.resolvedRole=this.ignore?"none":this.getAttribute("role")||void 0,this.resolvedSelects="none"===this.resolvedRole?"ignore":"none");const s="single"===this.resolvedSelects||"multiple"===this.resolvedSelects;t.item.menuData.cleanupSteps.push((t=>this.removeChildItem(t))),(s||!this.selects&&"ignore"!==this.resolvedSelects)&&!t.item.menuData.selectionRoot&&(t.item.setRole(this.childRole),t.item.menuData.selectionRoot=t.item.menuData.selectionRoot||this,t.item.selected&&(this.selectedItemsMap.set(t.item,!0),this.selectedItems=[...this.selectedItems,t.item],this._selected=[...this.selected,t.item.value],this.value=this.selected.join(this.valueSeparator)))}addChildItem(t){this.childItemSet.add(t),this.handleItemsChanged()}async removeChildItem(t){this.childItemSet.delete(t),this.cachedChildItems=void 0,t.focused&&(this.handleItemsChanged(),await this.updateComplete,this.focus())}focus({preventScroll:t}={}){if(!this.childItems.length||this.childItems.every((t=>t.disabled)))return;if(this.childItems.some((t=>t.menuData.focusRoot!==this)))return void super.focus({preventScroll:t});this.focusMenuItemByOffset(0),super.focus({preventScroll:t});const e=this.selectedItems[0];e&&!t&&e.scrollIntoView({block:"nearest"})}handleClick(t){const e=t.composedPath().find((t=>t instanceof Element&&t.getAttribute("role")===this.childRole));if(t.defaultPrevented){const t=this.childItems.indexOf(e);(null==e?void 0:e.menuData.focusRoot)===this&&t>-1&&(this.focusedItemIndex=t)}else null!=e&&e.href&&e.href.length?this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})):(null==e?void 0:e.menuData.selectionRoot)===this&&this.childItems.length&&(t.preventDefault(),e.hasSubmenu||e.open||(this.selectOrToggleItem(e),this.prepareToCleanUp()))}handleFocusin(t){var e;const o=To(this,t.relatedTarget);if(this.childItems.some((t=>t.menuData.focusRoot!==this)))return;const r=this.getRootNode().activeElement,s=(null==(e=this.childItems[this.focusedItemIndex])?void 0:e.menuData.selectionRoot)||this;if((r!==s||!o&&t.target!==this)&&(s.focus({preventScroll:!0}),r&&0===this.focusedItemIndex)){const t=this.childItems.findIndex((t=>t===r));this.focusMenuItemByOffset(Math.max(t,0))}this.startListeningToKeyboard()}startListeningToKeyboard(){this.addEventListener("keydown",this.handleKeydown)}handleFocusout(t){To(this,t.relatedTarget)||(this.stopListeningToKeyboard(),this.childItems.forEach((t=>t.focused=!1)),this.removeAttribute("aria-activedescendant"))}stopListeningToKeyboard(){this.removeEventListener("keydown",this.handleKeydown)}handleDescendentOverlayOpened(t){const e=t.composedPath()[0];e.overlayElement&&this.descendentOverlays.set(e.overlayElement,e.overlayElement)}handleDescendentOverlayClosed(t){const e=t.composedPath()[0];e.overlayElement&&this.descendentOverlays.delete(e.overlayElement)}async selectOrToggleItem(t){const e=this.resolvedSelects,o=new Map(this.selectedItemsMap),r=this.selected.slice(),s=this.selectedItems.slice(),c=this.value,a=this.childItems[this.focusedItemIndex];if(a&&(a.focused=!1,a.active=!1),this.focusedItemIndex=this.childItems.indexOf(t),this.forwardFocusVisibleToItem(t),"multiple"===e){this.selectedItemsMap.has(t)?this.selectedItemsMap.delete(t):this.selectedItemsMap.set(t,!0);const e=[],o=[];this.childItemSet.forEach((t=>{t.menuData.selectionRoot===this&&this.selectedItemsMap.has(t)&&(e.push(t.value),o.push(t))})),this._selected=e,this.selectedItems=o,this.value=this.selected.join(this.valueSeparator)}else this.selectedItemsMap.clear(),this.selectedItemsMap.set(t,!0),this.value=t.value,this._selected=[t.value],this.selectedItems=[t];if(!this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0})))return this._selected=r,this.selectedItems=s,this.selectedItemsMap=o,void(this.value=c);if("single"===e){for(const e of o.keys())e!==t&&(e.selected=!1);t.selected=!0}else"multiple"===e&&(t.selected=!t.selected)}navigateWithinMenu(t){const{code:e}=t,o=this.childItems[this.focusedItemIndex],r="ArrowDown"===e?1:-1,s=this.focusMenuItemByOffset(r);s!==o&&(t.preventDefault(),t.stopPropagation(),s.scrollIntoView({block:"nearest"}))}navigateBetweenRelatedMenus(t){const{code:e}=t,o=this.isLTR&&"ArrowRight"===e||!this.isLTR&&"ArrowLeft"===e,r=this.isLTR&&"ArrowLeft"===e||!this.isLTR&&"ArrowRight"===e;if(o){t.stopPropagation();const e=this.childItems[this.focusedItemIndex];null!=e&&e.hasSubmenu&&e.openOverlay()}else r&&this.isSubmenu&&(t.stopPropagation(),this.dispatchEvent(new Event("close",{bubbles:!0})),this.updateSelectedItemIndex())}handleKeydown(t){var e;if(t.target!==this&&this!==t.target.parentElement||t.defaultPrevented)return;const o=this.childItems[this.focusedItemIndex];o&&(o.focused=!0);const{code:r}=t;if(t.shiftKey&&t.target!==this&&this.hasAttribute("tabindex")){this.removeAttribute("tabindex");const t=e=>{!e.shiftKey&&!this.hasAttribute("tabindex")&&(this.tabIndex=0,document.removeEventListener("keyup",t),this.removeEventListener("focusout",t))};document.addEventListener("keyup",t),this.addEventListener("focusout",t)}"Tab"!==r?"Space"===r&&null!=o&&o.hasSubmenu?o.openOverlay():"Space"!==r&&"Enter"!==r?"ArrowDown"!==r&&"ArrowUp"!==r?this.navigateBetweenRelatedMenus(t):this.navigateWithinMenu(t):null==(e=this.childItems[this.focusedItemIndex])||e.click():this.prepareToCleanUp()}focusMenuItemByOffset(t){const e=t||1,o=this.childItems[this.focusedItemIndex];o&&(o.focused=!1,o.active=o.open),this.focusedItemIndex=(this.childItems.length+this.focusedItemIndex+t)%this.childItems.length;let r=this.childItems[this.focusedItemIndex],s=this.childItems.length;for(;null!=r&&r.disabled&&s;)s-=1,this.focusedItemIndex=(this.childItems.length+this.focusedItemIndex+e)%this.childItems.length,r=this.childItems[this.focusedItemIndex];return null!=r&&r.disabled||this.forwardFocusVisibleToItem(r),r}prepareToCleanUp(){document.addEventListener("focusout",(()=>{requestAnimationFrame((()=>{const t=this.childItems[this.focusedItemIndex];t&&(t.focused=!1,this.updateSelectedItemIndex())}))}),{once:!0})}updateSelectedItemIndex(){let t=0;const e=new Map,o=[],r=[];let s=this.childItems.length;for(;s;){s-=1;const c=this.childItems[s];c.menuData.selectionRoot===this&&((c.selected||!this._hasUpdatedSelectedItemIndex&&this.selected.includes(c.value))&&(t=s,e.set(c,!0),o.unshift(c.value),r.unshift(c)),s!==t&&(c.focused=!1))}r.map(((t,e)=>{e>0&&(t.focused=!1)})),this.selectedItemsMap=e,this._selected=o,this.selectedItems=r,this.value=this.selected.join(this.valueSeparator),this.focusedItemIndex=t,this.focusInItemIndex=t}handleItemsChanged(){this.cachedChildItems=void 0,this._willUpdateItems||(this._willUpdateItems=!0,this.cacheUpdated=this.updateCache())}async updateCache(){this.hasUpdated?await new Promise((t=>requestAnimationFrame((()=>t(!0))))):await Promise.all([new Promise((t=>requestAnimationFrame((()=>t(!0))))),this.updateComplete]),void 0===this.cachedChildItems&&(this.updateSelectedItemIndex(),this.updateItemFocus()),this._willUpdateItems=!1}updateItemFocus(){if(0==this.childItems.length)return;const t=this.childItems[this.focusInItemIndex];this.getRootNode().activeElement===t.menuData.focusRoot&&this.forwardFocusVisibleToItem(t)}closeDescendentOverlays(){this.descendentOverlays.forEach((t=>{t.open=!1})),this.descendentOverlays=new Map}forwardFocusVisibleToItem(t){if(!t||t.menuData.focusRoot!==this)return;this.closeDescendentOverlays();const e=this.hasVisibleFocusInTree()||!!this.childItems.find((t=>t.hasVisibleFocusInTree()));t.focused=e,this.setAttribute("aria-activedescendant",t.id),t.menuData.selectionRoot&&t.menuData.selectionRoot!==this&&t.menuData.selectionRoot.focus()}handleSlotchange({target:t}){const e=t.assignedElements({flatten:!0});this.childItems.length!==e.length&&e.forEach((t=>{void 0!==t.triggerUpdate&&t.triggerUpdate()}))}renderMenuItemSlot(){return t.dy`
        ...
        `;return this.hasRenderedOverlay=this.hasRenderedOverlay||this.focused||this.open||!!this.deprecatedMenu,this.hasRenderedOverlay?this.renderOverlay(e):e}shouldScheduleManageSelection(t){!this.willManageSelection&&(!t||t.target.getRootNode().host===this)&&(this.willManageSelection=!0,requestAnimationFrame((()=>{requestAnimationFrame((()=>{this.manageSelection()}))})))}shouldManageSelection(){this.willManageSelection||(this.willManageSelection=!0,this.manageSelection())}async manageSelection(){if(null==this.selects)return;let t;this.selectionPromise=new Promise((t=>this.selectionResolver=t)),await this.optionsMenu.updateComplete,this.recentlyConnected&&(await new Promise((t=>requestAnimationFrame((()=>t(!0))))),this.recentlyConnected=!1),this.menuItems.forEach((e=>{this.value!==e.value||e.disabled?e.selected=!1:t=e})),t?(t.selected=!!this.selects,this.selectedItem=t):(this.value="",this.selectedItem=void 0),this.open&&(await this.optionsMenu.updateComplete,this.optionsMenu.updateSelectedItemIndex()),this.selectionResolver(),this.willManageSelection=!1}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.selectionPromise,this.overlayElement&&await this.overlayElement.updateComplete,t}connectedCallback(){super.connectedCallback(),this.recentlyConnected=this.hasUpdated}disconnectedCallback(){this.close(),super.disconnectedCallback()}}Uo([(0,d.SB)()],Mo.prototype,"appliedLabel",2),Uo([(0,d.IO)("#button")],Mo.prototype,"button",2),Uo([(0,d.Cb)({type:Boolean,reflect:!0})],Mo.prototype,"disabled",2),Uo([(0,d.Cb)({type:Boolean,reflect:!0})],Mo.prototype,"focused",2),Uo([(0,d.Cb)({type:String,reflect:!0})],Mo.prototype,"icons",2),Uo([(0,d.Cb)({type:Boolean,reflect:!0})],Mo.prototype,"invalid",2),Uo([(0,d.Cb)()],Mo.prototype,"label",2),Uo([(0,d.Cb)({type:Boolean,reflect:!0})],Mo.prototype,"open",2),Uo([(0,d.Cb)({type:Boolean,reflect:!0})],Mo.prototype,"readonly",2),Uo([(0,d.IO)("sp-menu")],Mo.prototype,"optionsMenu",2),Uo([(0,d.IO)("sp-overlay")],Mo.prototype,"overlayElement",2),Uo([(0,d.Cb)()],Mo.prototype,"placement",2),Uo([(0,d.Cb)({type:Boolean,reflect:!0})],Mo.prototype,"quiet",2),Uo([(0,d.Cb)({type:String})],Mo.prototype,"value",2),Uo([(0,d.Cb)({attribute:!1})],Mo.prototype,"selectedItem",1),Uo([(0,d.Cb)({attribute:!1})],Mo.prototype,"selectedItemContent",1),(0,y.N)("sp-picker",class extends Mo{constructor(){super(...arguments),this.handleKeydown=t=>{const{code:e}=t;if(this.focused=!0,!e.startsWith("Arrow")||this.readonly)return;if("ArrowUp"===e||"ArrowDown"===e)return void this.toggle(!0);t.preventDefault();const o=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,r=o<0||"ArrowRight"===e?1:-1;let s=o+r;for(;this.menuItems[s]&&this.menuItems[s].disabled;)s+=r;!this.menuItems[s]||this.menuItems[s].disabled||(!this.value||s!==o)&&this.setValueFromItem(this.menuItems[s])}}static get styles(){return[$o,Ue]}get containerStyles(){const t=super.containerStyles;return this.quiet||(t["min-width"]=`${this.offsetWidth}px`),t}});const Fo=t.iv`
...
`;var Wo=Object.defineProperty;Object.getOwnPropertyDescriptor;class Zo extends(z(u.o,{validSizes:["s","m","l"],noDefaultSize:!0})){constructor(){super(...arguments),this.vertical=!1}render(){return t.dy``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Zo.styles=[Go],((t,e,o,r)=>{for(var s,c=void 0,a=t.length-1;a>=0;a--)(s=t[a])&&(c=s(e,o,c)||c);c&&Wo(e,o,c)})([(0,d.Cb)({type:Boolean,reflect:!0})],Zo.prototype,"vertical"),(0,y.N)("sp-divider",Zo);const Yo=t.iv`
...
`;var Jo=Object.defineProperty,Qo=Object.getOwnPropertyDescriptor,tr=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Qo(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Jo(e,o,c),c};class er extends(z(u.o,{noDefaultSize:!0})){constructor(){super(...arguments),this.icon=!1,this.variant="neutral"}static get styles(){return[Yo]}render(){return t.dy`
            ${"negative"===this.variant&&this.icon?t.dy`
                      <sp-icon-alert class="icon"></sp-icon-alert>
                  `:t.Ld}
            <div class="text"><slot></slot></div>
        `}}tr([(0,d.Cb)({type:Boolean,reflect:!0})],er.prototype,"icon",2),tr([(0,d.Cb)({reflect:!0})],er.prototype,"variant",2),(0,y.N)("sp-help-text",er);const or=t.iv`
...
`;var rr=Object.defineProperty,sr=Object.getOwnPropertyDescriptor,cr=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?sr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&rr(e,o,c),c};class ar extends(z(u.o,{noDefaultSize:!0})){constructor(){super(...arguments),this.allowMultiple=!1,this.focusGroupController=new U(this,{direction:"vertical",elements:()=>this.items,isFocusableElement:t=>!t.disabled})}static get styles(){return[or]}get items(){return[...this.defaultNodes||[]].filter((t=>void 0!==t.tagName))}focus(){this.focusGroupController.focus()}async onToggle(t){const e=t.target;if(await 0,this.allowMultiple||t.defaultPrevented)return;const o=[...this.items];o&&!o.length||o.forEach((t=>{t!==e&&(t.open=!1)}))}handleSlotchange(){this.focusGroupController.clearElementCache(),this.items.forEach((t=>{t.size=this.size}))}updated(t){super.updated(t),t.has("size")&&(t.get("size")||"m"!==this.size)&&this.items.forEach((t=>{t.size=this.size}))}render(){return t.dy`
            <slot
                @slotchange=${this.handleSlotchange}
                @sp-accordion-item-toggle=${this.onToggle}
            ></slot>
        `}}cr([(0,d.Cb)({type:Boolean,reflect:!0,attribute:"allow-multiple"})],ar.prototype,"allowMultiple",2),cr([(0,d.Cb)({type:String,reflect:!0})],ar.prototype,"density",2),cr([(0,d.vZ)()],ar.prototype,"defaultNodes",2),(0,y.N)("sp-accordion",ar);const ir=t.iv`
...
`;var nr=Object.defineProperty,lr=Object.getOwnPropertyDescriptor,ur=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?lr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&nr(e,o,c),c};const dr={s:()=>t.dy`
    ...
    `};class mr extends(z(D,{noDefaultSize:!0})){constructor(){super(...arguments),this.open=!1,this.label="",this.disabled=!1,this.renderChevronIcon=()=>dr[this.size||"m"]()}static get styles(){return[ir,Ue]}get focusElement(){return this.shadowRoot.querySelector("#header")}onClick(){this.disabled||this.toggle()}toggle(){this.open=!this.open,this.dispatchEvent(new CustomEvent("sp-accordion-item-toggle",{bubbles:!0,composed:!0,cancelable:!0}))||(this.open=!this.open)}render(){return t.dy`
        ...
        `}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}ur([(0,d.Cb)({type:Boolean,reflect:!0})],mr.prototype,"open",2),ur([(0,d.Cb)({type:String,reflect:!0})],mr.prototype,"label",2),ur([(0,d.Cb)({type:Boolean,reflect:!0})],mr.prototype,"disabled",2),(0,y.N)("sp-accordion-item",mr);const pr=t.iv`
...
`;var br=Object.defineProperty,gr=Object.getOwnPropertyDescriptor,vr=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?gr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&br(e,o,c),c};const fr=class e extends(gt(D)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[hr]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let t=0,o=this.parentElement;for(;o instanceof e;)t++,o=o.parentElement;return t}handleSideNavSelect(t){this.selected=t.target===this}handleClick(t){!this.href&&t&&t.preventDefault(),!this.disabled&&(!this.href||null!=t&&t.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(t){const e=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:t}});this.dispatchEvent(e)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return t.dy`
            <a
                href=${this.href||"#"}
                target=${(0,E.o)(this.target)}
                download=${(0,E.o)(this.download)}
...
`;var xr=Object.defineProperty;Object.getOwnPropertyDescriptor;class wr extends u.o{constructor(){super(...arguments),this.label=""}static get styles(){return[hr,yr]}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return t.dy`
        ...
        `}willUpdate(){if(!this.hasUpdated){const t=this.querySelector("[selected]");t&&(this.value=t.value)}}updated(t){super.updated(t),t.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}Ir([(0,d.Cb)({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],Sr.prototype,"manageTabIndex",2),Ir([(0,d.Cb)({reflect:!0})],Sr.prototype,"value",2),Ir([(0,d.Cb)({reflect:!0})],Sr.prototype,"variant",2),Ir([(0,d.Cb)({reflect:!0})],Sr.prototype,"label",2),(0,y.N)("sp-sidenav",Sr),(0,y.N)("sp-sidenav-heading",wr),(0,y.N)("sp-sidenav-item",kr);class Er extends xt{}const $r=t.iv`
...
`;var jr=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,_r=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?qr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&jr(e,o,c),c};const Tr={s:()=>t.dy`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>t.dy`
        ...
        ></sp-icon-cross300>
    `};class Hr extends(z(Er,{noDefaultSize:!0})){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,$r,Ar]}get buttonContent(){return[Tr[this.size]()]}}_r([(0,d.Cb)({reflect:!0})],Hr.prototype,"variant",2),_r([(0,d.Cb)({type:String,reflect:!0})],Hr.prototype,"static",2),(0,y.N)("sp-close-button",Hr),(0,y.N)("sp-icon-info",class extends g{render(){return k(t.dy),(({width:t=24,height:e=24,hidden:o=!1,title:r="Info"}={})=>f`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${e}
    viewBox="0 0 36 36"
    width=${t}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});const Lr=t.iv`
...
`;var Dr=Object.defineProperty,Pr=Object.getOwnPropertyDescriptor,Ur=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Pr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Dr(e,o,c),c};const Or=["negative","positive","info","error","warning"];class Br extends(q(u.o)){constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[Lr]}set timeout(t){const e=null!==typeof t&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Or.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(e){switch(e){case"info":return t.dy`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}Ur([(0,d.Cb)({type:Boolean,reflect:!0})],Br.prototype,"open",2),Ur([(0,d.Cb)({type:Number})],Br.prototype,"timeout",1),Ur([(0,d.Cb)({type:String})],Br.prototype,"variant",1),(0,y.N)("sp-toast",Br);const Mr=t.iv`
...
`;var Fr=Object.defineProperty,Nr=Object.getOwnPropertyDescriptor,Rr=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Nr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Fr(e,o,c),c};class Vr extends(z(u.o,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Mr]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const e=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return t.dy`
            <slot @slotchange=${this.handleSlotchange}></slot>
            <div class="track"></div>
            <div class="fills">
