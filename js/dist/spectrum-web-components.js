...
`;var O=Object.defineProperty,D=Object.getOwnPropertyDescriptor,B=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?D(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&O(e,o,c),c};const F={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t.iv`
        ...
        `}};class M extends(z(T)){constructor(){super(),this.auto=!1,this.compact=!1,this.direction="horizontal",this.emphasized=!1,this.label="",this.quiet=!1,this.selectionIndicatorStyle=F.noSelectionStyle,this.shouldAnimate=!1,this._selected="",this._tabs=[],this.rovingTabindexController=new j(this,{focusInIndex:t=>{let e=0;return t.find(((t,o)=>{const r=this.selected?!t.disabled&&t.value===this.selected:!t.disabled;return e=o,r}))?e:-1},direction:()=>"horizontal"===this.direction?"horizontal":"vertical",elementEnterAction:t=>{this.auto&&(this.shouldAnimate=!0,this.selectTarget(t))},elements:()=>this.tabs,isFocusableElement:t=>!t.disabled,listenerScope:()=>this.tabList}),this.onClick=t=>{if(this.disabled)return;const e=t.composedPath().find((t=>t.parentElement===this));!e||e.disabled||(this.shouldAnimate=!0,this.selectTarget(e))},this.onKeyDown=t=>{if("Enter"===t.code||"Space"===t.code){t.preventDefault();const e=t.target;e&&this.selectTarget(e)}},this.updateCheckedState=()=>{if(this.tabs.length||(this.tabs=[...this.querySelectorAll('[role="tab"]')]),this.tabs.forEach((t=>{t.removeAttribute("selected")})),this.selected){const t=this.tabs.find((t=>t.value===this.selected));t?t.selected=!0:this.selected=""}else{const t=this.tabs[0];t&&t.setAttribute("tabindex","0")}this.updateSelectionIndicator(),this.tabChangeResolver()},this.updateSelectionIndicator=async()=>{const t=this.tabs.find((t=>t.selected));if(!t)return void(this.selectionIndicatorStyle=F.noSelectionStyle);await Promise.all([t.updateComplete,document.fonts?document.fonts.ready:Promise.resolve()]);const{width:e,height:o}=t.getBoundingClientRect();this.selectionIndicatorStyle="horizontal"===this.direction?F.transformX(t.offsetLeft,e):F.transformY(t.offsetTop,o)},this.tabChangePromise=Promise.resolve(),this.tabChangeResolver=function(){},new I(this,{config:{root:null,rootMargin:"0px",threshold:[0,1]},callback:()=>{this.updateSelectionIndicator()}})}static get styles(){return[L,F.baseStyles()]}get selected(){return this._selected}set selected(t){const e=this.selected;t!==e&&(this._selected=t,this.shouldUpdateCheckedState(),this.requestUpdate("selected",e))}set tabs(t){t!==this.tabs&&(this._tabs=t,this.rovingTabindexController.clearElementCache())}get tabs(){return this._tabs}get focusElement(){return this.rovingTabindexController.focusInElement||this}manageAutoFocus(){const t=[...this.children].map((t=>void 0!==t.updateComplete?t.updateComplete:Promise.resolve(!0)));Promise.all(t).then((()=>super.manageAutoFocus()))}managePanels({target:t}){t.assignedElements().map((t=>{const{value:e,id:o}=t,r=this.querySelector(`[role="tab"][value="${e}"]`);r&&(r.setAttribute("aria-controls",o),t.setAttribute("aria-labelledby",r.id)),t.selected=e===this.selected}))}render(){return t.dy`
            ...
            >
                ...
                <div
                    ...
                    class=${(0,C.o)(this.shouldAnimate?void 0:"first-position")}
                    style=${this.selectionIndicatorStyle}
                    role="presentation"
                ></div>
            </div>
            <slot name="tab-panel" @slotchange=${this.managePanels}></slot>
        `}willUpdate(t){if(!this.hasUpdated){const t=this.querySelector(":scope > [selected]");t&&this.selectTarget(t)}if(super.updated(t),t.has("selected")){if(t.get("selected")){const e=this.querySelector(`[role="tabpanel"][value="${t.get("selected")}"]`);e&&(e.selected=!1)}const e=this.querySelector(`[role="tabpanel"][value="${this.selected}"]`);e&&(e.selected=!0)}t.has("direction")&&("horizontal"===this.direction?this.removeAttribute("aria-orientation"):this.setAttribute("aria-orientation","vertical")),t.has("dir")&&this.updateSelectionIndicator(),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled")),!this.shouldAnimate&&void 0!==t.get("shouldAnimate")&&(this.shouldAnimate=!0)}selectTarget(t){const e=t.getAttribute("value");if(e){const t=this.selected;this.selected=e,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=t)}}onSlotChange(){this.tabs=[...this.querySelectorAll('[role="tab"]')],this.shouldUpdateCheckedState()}shouldUpdateCheckedState(){this.tabChangeResolver(),this.tabChangePromise=new Promise((t=>this.tabChangeResolver=t)),setTimeout(this.updateCheckedState)}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.tabChangePromise,t}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.updateSelectionIndicator),"fonts"in document&&document.fonts.addEventListener("loadingdone",this.updateSelectionIndicator)}disconnectedCallback(){window.removeEventListener("resize",this.updateSelectionIndicator),"fonts"in document&&document.fonts.removeEventListener("loadingdone",this.updateSelectionIndicator),super.disconnectedCallback()}}B([(0,d.Cb)({type:Boolean})],M.prototype,"auto",2),B([(0,d.Cb)({type:Boolean,reflect:!0})],M.prototype,"compact",2),B([(0,d.Cb)({reflect:!0})],M.prototype,"direction",2),B([(0,d.Cb)({type:Boolean,reflect:!0})],M.prototype,"emphasized",2),B([(0,d.Cb)()],M.prototype,"label",2),B([(0,d.Cb)({type:Boolean,reflect:!0})],M.prototype,"quiet",2),B([(0,d.Cb)({attribute:!1})],M.prototype,"selectionIndicatorStyle",2),B([(0,d.Cb)({attribute:!1})],M.prototype,"shouldAnimate",2),B([(0,d.IO)("#list")],M.prototype,"tabList",2),B([(0,d.Cb)({reflect:!0})],M.prototype,"selected",1),customElements.define("sp-tabs",M);class R{constructor(t,{target:e,config:o,callback:r,skipInitial:s}){this.t=new Set,this.o=!1,this.i=!1,this.h=t,null!==e&&this.t.add(null!=e?e:t),this.l=o,this.o=null!=s?s:this.o,this.callback=r,window.MutationObserver?(this.u=new MutationObserver((t=>{this.handleChanges(t),this.h.requestUpdate()})),t.addController(this)):console.warn("MutationController error: browser does not support MutationObserver.")}handleChanges(t){var e;this.value=null===(e=this.callback)||void 0===e?void 0:e.call(this,t,this.u)}hostConnected(){for(const t of this.t)this.observe(t)}hostDisconnected(){this.disconnect()}async hostUpdated(){const t=this.u.takeRecords();(t.length||!this.o&&this.i)&&this.handleChanges(t),this.i=!1}observe(t){this.t.add(t),this.u.observe(t,this.l),this.i=!0,this.h.requestUpdate()}disconnect(){this.u.disconnect()}}var H=Object.defineProperty,N=Object.getOwnPropertyDescriptor,V=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?N(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&H(e,o,c),c};const K=Symbol("assignedNodes");function G(t,e){var o;class r extends t{constructor(...t){super(t),this.slotHasContent=!1,new R(this,{config:{characterData:!0,subtree:!0},callback:t=>{for(const e of t)if("characterData"===e.type)return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[K])return;const t=[...this[K]].filter((t=>!!t.tagName||!!t.textContent&&t.textContent.trim()));this.slotHasContent=t.length>0}update(t){if(!this.hasUpdated){const{childNodes:t}=this,o=[...t].filter((t=>t.tagName?e?t.getAttribute("slot")===e:!t.hasAttribute("slot"):!!t.textContent&&t.textContent.trim()));this.slotHasContent=o.length>0}super.update(t)}firstUpdated(t){super.firstUpdated(t),this.updateComplete.then((()=>{this.manageTextObservedSlot()}))}}return o=K,V([(0,d.Cb)({type:Boolean,attribute:!1})],r.prototype,"slotHasContent",2),V([(0,d.vZ)(e,!0)],r.prototype,o,2),r}const W=Symbol("slotContentIsPresent");function Y(t,e){var o;const r=Array.isArray(e)?e:[e];return o=W,class extends t{constructor(...t){super(t),this[o]=new Map,this.managePresenceObservedSlot=()=>{let t=!1;r.forEach((e=>{const o=!!this.querySelector(e),r=this[W].get(e)||!1;t=t||r!==o,this[W].set(e,!!this.querySelector(e))})),t&&this.updateComplete.then((()=>{this.requestUpdate()}))},new R(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(1===r.length)return this[W].get(r[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(t){if(this[W].has(t))return this[W].get(t)||!1;throw new Error(`The provided selector \`${t}\` is not being observed.`)}}}const Z=t.iv`
...
`;var X=Object.defineProperty,J=Object.getOwnPropertyDescriptor,Q=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?J(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&X(e,o,c),c};const tt=class extends(E(G(Y(u.o,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[Z]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}handleContentChange(){this.dispatchEvent(new Event("sp-tab-contentchange",{bubbles:!0,composed:!0}))}render(){return t.dy`
            ${this.hasIcon?t.dy`
                      <slot name="icon"></slot>
                  `:t.dy``}
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+tt.instanceCount++),this.shadowRoot.addEventListener("slotchange",this.handleContentChange)}updated(t){super.updated(t),t.has("label")&&void 0!==t.get("label")&&this.handleContentChange(),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};let et=tt;et.instanceCount=0,Q([(0,d.Cb)({type:Boolean,reflect:!0})],et.prototype,"disabled",2),Q([(0,d.Cb)({reflect:!0})],et.prototype,"label",2),Q([(0,d.Cb)({type:Boolean,reflect:!0})],et.prototype,"selected",2),Q([(0,d.Cb)({type:Boolean,reflect:!0})],et.prototype,"vertical",2),Q([(0,d.Cb)({type:String,reflect:!0})],et.prototype,"value",2),customElements.define("sp-tab",et);const ot=t.iv`
:host{display:inline-flex}:host(:not([selected])){display:none}
`;var rt=Object.defineProperty,st=Object.getOwnPropertyDescriptor,ct=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?st(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&rt(e,o,c),c};const at=class extends u.o{constructor(){super(...arguments),this.selected=!1,this.value=""}render(){return t.dy`
            <slot></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+at.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};let it=at;it.styles=[ot],it.instanceCount=0,ct([(0,d.Cb)({type:Boolean,reflect:!0})],it.prototype,"selected",2),ct([(0,d.Cb)({type:String,reflect:!0})],it.prototype,"value",2),customElements.define("sp-tab-panel",it);var nt=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,ut=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?lt(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&nt(e,o,c),c};function dt(e){class o extends e{renderAnchor({id:e,className:o,ariaHidden:r,labelledby:s,tabindex:c,anchorContent:a=t.dy`<slot></slot>`}){return t.dy`<a
                    id=${e}
                    class=${(0,C.o)(o)}
                    href=${(0,C.o)(this.href)}
                    download=${(0,C.o)(this.download)}
                    target=${(0,C.o)(this.target)}
                    aria-label=${(0,C.o)(this.label)}
                    aria-labelledby=${(0,C.o)(s)}
                    aria-hidden=${(0,C.o)(r?"true":void 0)}
                    tabindex=${(0,C.o)(c)}
                    rel=${(0,C.o)(this.rel)}
                >${a}</a>`}}return ut([(0,d.Cb)({reflect:!0})],o.prototype,"download",2),ut([(0,d.Cb)()],o.prototype,"label",2),ut([(0,d.Cb)({reflect:!0})],o.prototype,"href",2),ut([(0,d.Cb)({reflect:!0})],o.prototype,"target",2),ut([(0,d.Cb)({reflect:!0})],o.prototype,"rel",2),o}var mt=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,bt=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?pt(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&mt(e,o,c),c};class ht extends(dt(G(Y(T,'[slot="icon"]')))){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return this.slotHasContent}get focusElement(){return this}get buttonContent(){const e=[t.dy`
...
`;let ft;const xt=function(t,...e){return ft?ft(t,...e):e.reduce(((e,o,r)=>e+o+t[r+1]),t[0])},yt=t=>{ft=t};customElements.define("sp-icon-corner-triangle300",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Corner Triangle300"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}});var kt=Object.defineProperty,wt=Object.getOwnPropertyDescriptor,zt=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?wt(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&kt(e,o,c),c};const Ct={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let It;class qt extends(z(ht,{validSizes:["xs","s","m","l","xl"]})){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[vt,gt]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){0===t.button&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),It=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300))}onPointerup(){clearTimeout(It),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:o}=t;("Space"===e||o&&"ArrowDown"===e)&&(t.preventDefault(),"ArrowDown"===e&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:o}=t;("Space"===e||o&&"ArrowDown"===e)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const e=super.buttonContent;return this.holdAffordance&&e.unshift(t.dy`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${Ct[this.size]}"
                ></sp-icon-corner-triangle300>
            `),e}updated(t){super.updated(t);const e="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(e?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}zt([(0,d.Cb)({type:Boolean,reflect:!0})],qt.prototype,"emphasized",2),zt([(0,d.Cb)({type:Boolean,reflect:!0,attribute:"hold-affordance"})],qt.prototype,"holdAffordance",2),zt([(0,d.Cb)({type:Boolean,reflect:!0})],qt.prototype,"quiet",2),zt([(0,d.Cb)({reflect:!0})],qt.prototype,"role",2),zt([(0,d.Cb)({type:Boolean,reflect:!0})],qt.prototype,"selected",2),zt([(0,d.Cb)({type:Boolean,reflect:!0})],qt.prototype,"toggles",2),zt([(0,d.Cb)({reflect:!0})],qt.prototype,"variant",2),zt([(0,d.Cb)({type:String})],qt.prototype,"value",1),customElements.define("sp-action-button",qt);const Et=t.iv`
...
`;var St=Object.defineProperty;Object.getOwnPropertyDescriptor;class $t extends(z(u.o)){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Et]}handleSlotchange({target:t}){t.assignedElements().forEach((t=>{t.size=this.size}))}render(){return t.dy`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((t,e,o,r)=>{for(var s,c=void 0,a=t.length-1;a>=0;a--)(s=t[a])&&(c=s(e,o,c)||c);c&&St(e,o,c)})([(0,d.Cb)({type:Boolean,reflect:!0})],$t.prototype,"vertical"),customElements.define("sp-button-group",$t);const At=t.iv`
...
`;class _t extends ht{static get styles(){return[At]}}const Tt=t.iv`
...
`;var Ut=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,jt=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Pt(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Ut(e,o,c),c};const Lt=["accent","primary","secondary","negative","white","black"];class Ot extends(z(_t)){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,Tt]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:Lt.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}jt([(0,d.Cb)()],Ot.prototype,"variant",1),jt([(0,d.Cb)({type:String,reflect:!0})],Ot.prototype,"static",2),jt([(0,d.Cb)({reflect:!0})],Ot.prototype,"treatment",2),jt([(0,d.Cb)({type:Boolean})],Ot.prototype,"quiet",1),customElements.define("sp-button",Ot),customElements.define("sp-icon-asterisk100",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Asterisk100"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
...
`;var Nt=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,Kt=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Vt(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Nt(e,o,c),c};const Gt=class extends(z(u.o)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1,this.resolvedElement=new Rt(this)}static get styles(){return[Ht,Dt]}handleClick(t){if(!this.target||this.disabled||t.defaultPrevented)return;this.target.focus();const e=this.getRootNode(),o=this.target,r=o.getRootNode(),s=r.host;r===e&&o.forceFocusVisible?o.forceFocusVisible():s&&s.forceFocusVisible&&s.forceFocusVisible()}addTarget(t){this.target=t.focusElement||t,this.target.getRootNode()===this.getRootNode()?Ft(this.target,"aria-labelledby",[this.id]):this.target.setAttribute("aria-label",this.labelText)}removeTarget(){this.target&&(this.target.getRootNode()===this.getRootNode()?Bt(this.target,"aria-labelledby",[this.id]):this.target.removeAttribute("aria-label"))}async manageTarget(){this.removeTarget();const t=this.resolvedElement.element;t?(t.localName.search("-")>0&&await customElements.whenDefined(t.localName),void 0!==t.updateComplete&&await t.updateComplete,this.addTarget(t)):this.target=t}get labelText(){const t=this.slotEl.assignedNodes({flatten:!0});return t.length?t.map((t=>(t.textContent||"").trim())).join(" "):""}render(){return t.dy`
            <label>
                <slot></slot>
                ${this.required?t.dy`
                          <sp-icon-asterisk100
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("click",this.handleClick)}willUpdate(t){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${Gt.instanceCount++}`),t.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(t.has("id")||t.has(Mt))&&this.manageTarget()}};let Wt=Gt;Wt.instanceCount=0,Kt([(0,d.Cb)({type:Boolean,reflect:!0})],Wt.prototype,"disabled",2),Kt([(0,d.Cb)({type:String})],Wt.prototype,"id",2),Kt([(0,d.Cb)({type:String})],Wt.prototype,"for",2),Kt([(0,d.Cb)({type:Boolean,reflect:!0})],Wt.prototype,"required",2),Kt([(0,d.IO)("slot")],Wt.prototype,"slotEl",2),Kt([(0,d.Cb)({type:String,reflect:!0,attribute:"side-aligned"})],Wt.prototype,"sideAligned",2),customElements.define("sp-field-label",Wt);var Yt=a(692);const Zt=t=>(...e)=>({_$litDirective$:t,values:e});class Xt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,o){this._$Ct=t,this._$AM=e,this._$Ci=o}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const{I:Jt}=Yt.Al,Qt=t=>void 0===t.strings,te={},ee=Zt(class extends Xt{constructor(t){if(super(t),3!==t.type&&1!==t.type&&4!==t.type)throw Error("The `live` directive is not allowed on child or event bindings");if(!Qt(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===Yt.Jb||e===Yt.Ld)return e;const o=t.element,r=t.name;if(3===t.type){if(e===o[r])return Yt.Jb}else if(4===t.type){if(!!e===o.hasAttribute(r))return Yt.Jb}else if(1===t.type&&o.getAttribute(r)===e+"")return Yt.Jb;return((t,e=te)=>{t._$AH=e})(t),e}}),oe=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=oe.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(e){return t.dy`
            <div id=${(0,C.o)(this.isInternal?this.id:void 0)}>
                <slot
...
`;var ae=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,ne=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?ie(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&ae(e,o,c),c};const le=["text","url","tel","email","password"];class ue extends(function(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new re(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(t){return this.helpTextManager.render(t)}}}(T)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[se,ce]}get type(){var t;return null!=(t=le.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?t.dy`
            ...
            <textarea
                ...
                aria-invalid=${(0,C.o)(this.invalid||void 0)}
                class="input"
                maxlength=${(0,C.o)(this.maxlength>-1?this.maxlength:void 0)}
                minlength=${(0,C.o)(this.minlength>-1?this.minlength:void 0)}
                pattern=${(0,C.o)(this.pattern)}
                ...
                autocomplete=${(0,C.o)(this.autocomplete)}
            ></textarea>
...
`;var Me=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,He=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Re(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Me(e,o,c),c};const Ne={"１":"1","２":"2","３":"3","４":"4","５":"5","６":"6","７":"7","８":"8","９":"9","０":"0","、":",","，":",","。":".","．":".","％":"%","＋":"+",ー:"-"};class Ve extends ue{constructor(){super(...arguments),this.focused=!1,this._forcedUnit="",this.formatOptions={},this.hideStepper=!1,this.indeterminate=!1,this.keyboardFocused=!1,this.managedInput=!1,this.stepModifier=10,this._value=NaN,this._trackingValue="",this.changeCount=0,this.languageResolver=new pe(this),this.wasIndeterminate=!1}static get styles(){return[...super.styles,Fe,Be]}set value(t){const e=this.validateInput(t);if(e===this.value)return;const o=this._value;this._value=e,this.requestUpdate("value",o)}get value(){return this._value}get inputValue(){return this.indeterminate?this.formattedValue:this.inputElement.value}get valueAsString(){return this._value.toString()}set valueAsString(t){this.value=this.numberParser.parse(t)}get formattedValue(){return isNaN(this.value)?"":this.numberFormatter.format(this.value)+(this.focused?"":this._forcedUnit)}convertValueToNumber(t){var e;if(De()&&"decimal"===this.inputElement.inputMode){const o=this.numberFormatter.formatToParts(1000.1),r=t.split("").find((t=>","===t||"."===t)),s=null==(e=o.find((t=>"decimal"===t.type)))?void 0:e.value;r&&s&&(t=t.replace(r,s))}return this.numberParser.parse(t)}get _step(){var t;return void 0!==this.step?this.step:"percent"===(null==(t=this.formatOptions)?void 0:t.style)?.01:1}handlePointerdown(t){if(0!==t.button)return void t.preventDefault();this.managedInput=!0,this.buttons.setPointerCapture(t.pointerId);const e=this.buttons.children[0].getBoundingClientRect(),o=this.buttons.children[1].getBoundingClientRect();this.findChange=t=>{t.clientX>=e.x&&t.clientY>=e.y&&t.clientX<=e.x+e.width&&t.clientY<=e.y+e.height?this.change=t=>this.increment(t.shiftKey?this.stepModifier:1):t.clientX>=o.x&&t.clientY>=o.y&&t.clientX<=o.x+o.width&&t.clientY<=o.y+o.height&&(this.change=t=>this.decrement(t.shiftKey?this.stepModifier:1))},this.findChange(t),this.startChange(t)}startChange(t){this.changeCount=0,this.doChange(t),this.safty=setTimeout((()=>{this.doNextChange(t)}),400)}doChange(t){this.change(t)}handlePointermove(t){this.findChange(t)}handlePointerup(t){this.buttons.releasePointerCapture(t.pointerId),cancelAnimationFrame(this.nextChange),clearTimeout(this.safty),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.managedInput=!1}doNextChange(t){return this.changeCount+=1,this.changeCount%5==0&&this.doChange(t),requestAnimationFrame((()=>{this.nextChange=this.doNextChange(t)}))}stepBy(t){if(this.disabled||this.readonly)return;const e=void 0!==this.min?this.min:0;let o=this.value;o+=t*this._step,isNaN(this.value)?this.value=e:this.value=o,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.indeterminate=!1,this.focus()}increment(t=1){this.stepBy(1*t)}decrement(t=1){this.stepBy(-1*t)}handleKeydown(t){switch(t.code){case"ArrowUp":t.preventDefault(),this.increment(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));break;case"ArrowDown":t.preventDefault(),this.decrement(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}onScroll(t){t.preventDefault(),this.managedInput=!0;const e=t.shiftKey?t.deltaX/Math.abs(t.deltaX):t.deltaY/Math.abs(t.deltaY);0!==e&&!isNaN(e)&&(this.stepBy(e*(t.shiftKey?this.stepModifier:1)),clearTimeout(this.queuedChangeEvent),this.queuedChangeEvent=setTimeout((()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),100)),this.managedInput=!1}onFocus(){super.onFocus(),this._trackingValue=this.inputValue,this.keyboardFocused=!this.readonly&&!0,this.addEventListener("wheel",this.onScroll,{passive:!1})}onBlur(){super.onBlur(),this.keyboardFocused=!this.readonly&&!1,this.removeEventListener("wheel",this.onScroll)}handleFocusin(){this.focused=!this.readonly&&!0,this.keyboardFocused=!this.readonly&&!0}handleFocusout(){this.focused=!this.readonly&&!1,this.keyboardFocused=!this.readonly&&!1}handleChange(){const t=this.convertValueToNumber(this.inputValue);this.wasIndeterminate&&(this.wasIndeterminate=!1,this.indeterminateValue=void 0,isNaN(t))?this.indeterminate=!0:(this.value=t,super.handleChange())}handleInput(){this.indeterminate&&(this.wasIndeterminate=!0,this.indeterminateValue=this.value,this.inputElement.value=this.inputElement.value.replace("-",""));const{value:t,selectionStart:e}=this.inputElement,o=t.split("").map((t=>Ne[t]||t)).join("");if(this.numberParser.isValidPartialNumber(o)){const t=this.convertValueToNumber(o);return!o&&this.indeterminateValue?(this.indeterminate=!0,this._value=this.indeterminateValue):(this.indeterminate=!1,this._value=this.validateInput(t)),this._trackingValue=o,void(this.inputElement.value=o)}const r=o.length,s=(e||r)-(r-this._trackingValue.length);this.inputElement.value=this.indeterminate?"-":this._trackingValue,this.inputElement.setSelectionRange(s,s)}validateInput(t){if(void 0!==this.min&&(t=Math.max(this.min,t)),void 0!==this.max&&(t=Math.min(this.max,t)),this.step){const e=(t-(void 0!==this.min?this.min:0))%this.step;if(0===e||(1===Math.round(e/this.step)?t+=this.step-e:t-=e),void 0!==this.max)for(;t>this.max;)t-=this.step}return t}get displayValue(){const t=this.focused?"":"-";return this.indeterminate?t:this.formattedValue}clearNumberFormatterCache(){this._numberFormatter=void 0,this._numberParser=void 0}get numberFormatter(){if(!this._numberFormatter||!this._numberFormatterFocused){const{style:t,unit:e,unitDisplay:o,...r}=this.formatOptions;"unit"!==t&&(r.style=t),this._numberFormatterFocused=new Ee(this.languageResolver.language,r);try{this._numberFormatter=new Ee(this.languageResolver.language,this.formatOptions),this._forcedUnit="",this._numberFormatter.format(1)}catch(o){"unit"===t&&(this._forcedUnit=e),this._numberFormatter=this._numberFormatterFocused}}return this.focused?this._numberFormatterFocused:this._numberFormatter}get numberParser(){if(!this._numberParser||!this._numberParserFocused){const{style:t,unit:e,unitDisplay:o,...r}=this.formatOptions;"unit"!==t&&(r.style=t),this._numberParserFocused=new Ae(this.languageResolver.language,r);try{this._numberParser=new Ae(this.languageResolver.language,this.formatOptions),this._forcedUnit="",this._numberParser.parse("0")}catch(o){"unit"===t&&(this._forcedUnit=e),this._numberParser=this._numberParserFocused}}return this.focused?this._numberParserFocused:this._numberParser}renderField(){return this.autocomplete="off",t.dy`
            ...
            ${this.hideStepper?t.dy``:t.dy`
                  ...
                  `}
        `}update(t){if((t.has("formatOptions")||t.has("resolvedLanguage"))&&this.clearNumberFormatterCache(),t.has("value")||t.has("max")||t.has("min")){const t=this.numberParser.parse(this.formattedValue.replace(this._forcedUnit,""));this.value=t}super.update(t)}willUpdate(t){this.multiline=!1,t.has(me)&&this.clearNumberFormatterCache()}firstUpdated(t){super.firstUpdated(t),this.addEventListener("keydown",this.handleKeydown)}updated(t){if(t.has("min")||t.has("formatOptions")){let t="numeric";const o=void 0!==this.min&&this.min<0,{maximumFractionDigits:r}=this.numberFormatter.resolvedOptions(),s=r>0;De()?o?t="text":s&&(t="decimal"):(e=/Android/,"undefined"!=typeof window&&null!=window.navigator&&e.test(window.navigator.userAgent)&&(o?t="numeric":s&&(t="decimal"))),this.inputElement.inputMode=t}var e}}He([(0,d.IO)(".buttons")],Ve.prototype,"buttons",2),He([(0,d.Cb)({type:Boolean,reflect:!0})],Ve.prototype,"focused",2),He([(0,d.Cb)({type:Object,attribute:"format-options"})],Ve.prototype,"formatOptions",2),He([(0,d.Cb)({type:Boolean,reflect:!0,attribute:"hide-stepper"})],Ve.prototype,"hideStepper",2),He([(0,d.Cb)({type:Boolean,reflect:!0})],Ve.prototype,"indeterminate",2),He([(0,d.Cb)({type:Boolean,reflect:!0,attribute:"keyboard-focused"})],Ve.prototype,"keyboardFocused",2),He([(0,d.Cb)({type:Number})],Ve.prototype,"max",2),He([(0,d.Cb)({type:Number})],Ve.prototype,"min",2),He([(0,d.Cb)({type:Number})],Ve.prototype,"step",2),He([(0,d.Cb)({type:Number,reflect:!0,attribute:"step-modifier"})],Ve.prototype,"stepModifier",2),He([(0,d.Cb)({type:Number})],Ve.prototype,"value",1),customElements.define("sp-number-field",Ve);var Ke=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,We=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Ge(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Ke(e,o,c),c};class Ye extends T{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return t.dy`
            <input
                id="input"
                ...
                @change=${this.handleChange}
            />
        `}}We([(0,d.Cb)({type:Boolean,reflect:!0})],Ye.prototype,"checked",2),We([(0,d.Cb)({type:Boolean,reflect:!0})],Ye.prototype,"readonly",2),We([(0,d.IO)("#input")],Ye.prototype,"inputElement",2),customElements.define("sp-icon-checkmark75",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Checkmark75"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-checkmark200",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Checkmark200"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-checkmark300",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Checkmark300"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-dash75",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Dash75"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),customElements.define("sp-icon-dash100",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Dash100"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),customElements.define("sp-icon-dash200",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Dash200"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),customElements.define("sp-icon-dash300",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Dash300"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`;var Je=Object.defineProperty,Qe=Object.getOwnPropertyDescriptor,to=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Qe(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Je(e,o,c),c};const eo={s:t.dy`
    ...
    `,xl:t.dy`
        ...
        ></sp-icon-dash300>
    `};class ro extends(z(Ye)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Ze,ce,Xe]}render(){return t.dy`
            ${super.render()}
            <span id="box">
                ${eo[this.size]}
                ${oo[this.size]}
...
`;var co=Object.defineProperty,ao=Object.getOwnPropertyDescriptor,io=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?ao(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&co(e,o,c),c};class no extends(dt(T)){static get styles(){return[so]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}io([(0,d.IO)("#anchor")],no.prototype,"anchorElement",2),io([(0,d.Cb)({type:String,reflect:!0})],no.prototype,"variant",2),io([(0,d.Cb)({type:String,reflect:!0})],no.prototype,"static",2),customElements.define("sp-link",no);const lo=t.iv`
...
`;var ko=Object.defineProperty,wo=Object.getOwnPropertyDescriptor,zo=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?wo(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&ko(e,o,c),c};class Co extends u.o{constructor(){super(...arguments),this.disabled=!1,this.focused=!1,this.open=!1,this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[yo]}handlePointerdown(t){"touch"===t.pointerType&&(this.open=!0),this.setPointerCapture(t.pointerId)}handlePointerup(t){this.open=!1,this.releasePointerCapture(t.pointerId)}render(){return t.dy`
            ...
            ></sp-color-loupe>
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("pointerup",this.handlePointerup),this.addEventListener("pointercancel",this.handlePointerup)}}zo([(0,d.Cb)({type:Boolean,reflect:!0})],Co.prototype,"disabled",2),zo([(0,d.Cb)({type:Boolean,reflect:!0})],Co.prototype,"focused",2),zo([(0,d.Cb)({type:Boolean,reflect:!0})],Co.prototype,"open",2),zo([(0,d.Cb)({type:String})],Co.prototype,"color",2),customElements.define("sp-color-handle",Co);const Io=Zt(class extends Xt{constructor(t){var e;if(super(t),1!==t.type||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){var o,r;if(void 0===this.nt){this.nt=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!(null===(o=this.st)||void 0===o?void 0:o.has(t))&&this.nt.add(t);return this.render(e)}const s=t.element.classList;this.nt.forEach((t=>{t in e||(s.remove(t),this.nt.delete(t))}));for(const t in e){const o=!!e[t];o===this.nt.has(t)||(null===(r=this.st)||void 0===r?void 0:r.has(t))||(o?(s.add(t),this.nt.add(t)):(s.remove(t),this.nt.delete(t)))}return Yt.Jb}}),qo=t.iv`
...
`;var Eo=a(731);customElements.define("sp-icon-chevron100",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Chevron100"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`;var Sr=Object.defineProperty,$r=Object.getOwnPropertyDescriptor,Ar=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?$r(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Sr(e,o,c),c};class _r extends T{constructor(){super(...arguments),this.open=!1,this.label="",this.disabled=!1}static get styles(){return[Er,Be]}get focusElement(){return this.shadowRoot.querySelector("#header")}onClick(){this.disabled||this.toggle()}toggle(){this.open=!this.open,this.dispatchEvent(new CustomEvent("sp-accordion-item-toggle",{bubbles:!0,composed:!0,cancelable:!0}))||(this.open=!this.open)}render(){return t.dy`
            <h3 id="heading">
                <button
                    id="header"
                    @click=${this.onClick}
...
`;var Pr=Object.defineProperty,jr=Object.getOwnPropertyDescriptor,Lr=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?jr(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Pr(e,o,c),c};const Or=class extends(dt(T)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[Ur]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let t=0,e=this.parentElement;for(;e instanceof Or;)t++,e=e.parentElement;return t}handleSideNavSelect(t){this.selected=t.target===this}handleClick(t){!this.href&&t&&t.preventDefault(),!this.disabled&&(!this.href||null!=t&&t.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(t){const e=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:t}});this.dispatchEvent(e)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return t.dy`
            <a
                ...
                id="item-link"
                aria-current=${(0,C.o)(this.selected&&this.href?"page":void 0)}
            >
                <slot name="icon"></slot>
                ${this.label}
                <slot></slot>
...
`;var Fr=Object.defineProperty;Object.getOwnPropertyDescriptor;class Mr extends u.o{constructor(){super(...arguments),this.label=""}static get styles(){return[Ur,Br]}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return t.dy`
        ...
        `}willUpdate(){if(!this.hasUpdated){const t=this.querySelector("[selected]");t&&(this.value=t.value)}}updated(t){super.updated(t),t.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}Nr([(0,d.Cb)({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],Vr.prototype,"manageTabIndex",2),Nr([(0,d.Cb)({reflect:!0})],Vr.prototype,"value",2),customElements.define("sp-sidenav",Vr),customElements.define("sp-sidenav-heading",Mr),customElements.define("sp-sidenav-item",Dr);const Kr=t.iv`
...
`;customElements.define("sp-icon-cross75",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Cross75"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-cross100",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Cross100"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-cross200",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Cross200"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-cross300",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Cross300"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`;var Wr=Object.defineProperty;Object.getOwnPropertyDescriptor;const Yr={s:()=>t.dy`
    ...
    `,xl:()=>t.dy`
        ...
        ></sp-icon-cross300>
    `};class Zr extends(z(_t)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Kr,Gr]}get buttonContent(){return[Yr[this.size]()]}}((t,e,o,r)=>{for(var s,c=void 0,a=t.length-1;a>=0;a--)(s=t[a])&&(c=s(e,o,c)||c);c&&Wr(e,o,c)})([(0,d.Cb)({reflect:!0})],Zr.prototype,"variant"),customElements.define("sp-close-button",Zr),customElements.define("sp-icon-info",class extends v{render(){return x(t.dy),(({width:t=24,height:e=24,hidden:o=!1,title:r="Info"}={})=>f`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${e}
    viewBox="0 0 36 36"
    width=${t}
