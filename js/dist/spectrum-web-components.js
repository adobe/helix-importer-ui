...
`;var Ut=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,jt=(t,e,o,r)=>{for(var s,c=r>1?void 0:r?Pt(e,o):e,a=t.length-1;a>=0;a--)(s=t[a])&&(c=(r?s(e,o,c):s(c))||c);return r&&c&&Ut(e,o,c),c};const Lt=["accent","primary","secondary","negative","white","black"];class Ot extends(z(_t)){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,Tt]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:Lt.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}}jt([(0,d.Cb)()],Ot.prototype,"variant",1),jt([(0,d.Cb)({type:String,reflect:!0})],Ot.prototype,"static",2),jt([(0,d.Cb)({reflect:!0})],Ot.prototype,"treatment",2),jt([(0,d.Cb)({type:Boolean})],Ot.prototype,"quiet",1),customElements.define("sp-button",Ot),customElements.define("sp-icon-asterisk100",class extends v{render(){return yt(t.dy),(({width:t=24,height:e=24,title:o="Asterisk100"}={})=>xt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
